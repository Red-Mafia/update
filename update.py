...
\033[0;97m██║  ██║    ██║  ██╗
\033[0;97m╚═╝  ╚═╝    ╚═╝  ╚═╝
\033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By RED-MAFIA
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| Github.com/RED-MAFIA
 \033[0;96m  /_/       /_/  /_/____/_/ \033[0;91mv2.0  \033[0m|| Facebook.comRed-Mafia'''
...
def yayanxd():
    ...
    try:
        ...
        os.system('xdg-open https://chat.whatsapp.com/F6TJYhVtzO14FsmK2yepUk')
        moch_yayan()
    except KeyError:
...
def info_tools():
    ...
    print '\n %s[%s>%s] Author   : RED-MAFIA(RK)RIAZKHAN.'%(N,H,N);time.sleep(0.07)
